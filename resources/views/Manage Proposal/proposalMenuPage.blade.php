                            ...
                            <table class="style-table" id="table-id">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <option class="dropdown" value="Approved">Approved</option>
                                        <option class="dropdown" value="In Progress">In Progress</option>
                                        <option class="dropdown" value="Rejected">Rejected</option>
                                        </select>
                                        </td>
                                        <td>Test</td>
                                        <td>Test</td>
                                        <td><a href="proposalDetailsPage">View</a> | <a href="#">Update</a></td>
                                    </tr>
